...
class EditContactPage extends StatefulWidget {
  ...
  @override
  _EditContactPageState createState() => _EditContactPageState(this.contact);
}
...
class _EditContactPageState extends State<EditContactPage> {
  ...
  _EditContactPageState(this.contact);

  @override
  Widget build(BuildContext context) {
    textNameController.text = contact.name;
    textPositionController.text = contact.position;
    textCompanyController.text = contact.company;
    textAddress1Controller.text = contact.address1;
    textAddress2Controller.text = contact.address2;
    textPhoneController.text = contact.phone;
    textEmailController.text = contact.email;
